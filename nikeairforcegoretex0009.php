...
<br>
                ...
                <img src="kepucet/nikeairforcegoretex3/3.jfif" alt="shkembi ne korce">
...
<br>
                ...
                <img src="kepucet/nikeairforcegoretex3/2.jfif" alt="Kodra ne brezovice">
...
<br>
                ...
                <img src="kepucet/nikeairforcegoretex3/1.jfif" alt="Kodra ne brezovice">
        ...
        <div class="djatht">
         ...
         <label for="numriser" style="color:black;display:none;">id</label> 
                ...
                <input type="text" name="numriser"id="numriser" class="form-control" required style="width:200px; color:black;display:none; z-index:-100;" value="NIKE AIR FORCE GORE TEX ID#0009">
