...
.navigimi{display:flex;justify-content:center; flex-direction:row; width:500px;}
 ...
 <title>NIKE AIR FORCE GORE TEX</title>
    </head>
    <body>
...
<br>
                ...
                <img src="kepucet/nikeairforcegoretex6/1.jfif" alt="shkembi ne korce">

                <div class="pershkrimi" id="pershkrimi">
                    <p>NIKE AIR FORCE GORE TEX</p>
                </div> 
...
<br>
                ...
                <img src="kepucet/nikeairforcegoretex6/2.jfif" alt="Kodra ne brezovice">
...
<br>
                ...
                <img src="kepucet/nikeairforcegoretex6/3.jfif" alt="Kodra ne brezovice">

                <div class="pershkrimi" id="pershkrimi">
                    <p style="text-transfrom:uppercase">NIKE AIR FORCE GORE TEX</p>
                </div>
            </div>
        ...
        <div class="pikat-naviguese">
            <span class="pika" id="pika">132 &euro;</span>
        </div>
        </div>

        <div class="djatht">

             <h1 style="text-align:center; text-transform:capitalize;">NIKE AIR FORCE GORE TEX</h1>
         ...
         <label for="numriser" style="color:black;display:none;">id</label> 
                ...
                <input type="text" name="numriser"id="numriser" class="form-control" required style="width:200px; color:black;display:none; z-index:-100;" value="NIKE AIR FORCE GORE TEX ID#0021">
        ...
        <label for="cmimi" style="color:black;display:none;">Phone</label> 
                ...
                <input type="tel" name="cmimi" id="cmimi" class="form-control" required style="width:200px; color:black; display:none;" value="132" > 
