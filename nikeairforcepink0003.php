...
.navigimi{display:flex;justify-content:center; flex-direction:row; width:500px;}
 ...
 <title>NIKE AIR FORCE PINK</title>
    </head>
    <body>
...
<br>
                ...
                <img src="kepucet/nikeairforcepink/1.jpeg" alt="shkembi ne korce">

                <div class="pershkrimi" id="pershkrimi">
                    <p>NIKE AIR FORCE PINK</p>
                </div> 
...
<br>
                ...
                <img src="kepucet/nikeairforcepink/2.jpeg" alt="Kodra ne brezovice">
...
<br>
                ...
                <img src="kepucet/nikeairforcepink/3.jpeg" alt="Kodra ne brezovice">

                <div class="pershkrimi" id="pershkrimi">
                    <p style="text-transfrom:uppercase">NIKE AIR FORCE PINK</p>
                </div>
            </div>
        ...
        <div class="pikat-naviguese">
            <span class="pika" id="pika">102 &euro;</span>
        </div>
        </div>
        ...
        <div class="djatht">
         ...
         <label for="numriser" style="color:black;display:none;">id</label> 
                ...
                <input type="text" name="numriser"id="numriser" class="form-control" required style="width:200px; color:black;display:none; z-index:-100;" value="NIKE AIR FORCE PINK ID#0003">
        ...
        <label for="cmimi" style="color:black;display:none;">Phone</label> 
                ...
                <input type="tel" name="cmimi" id="cmimi" class="form-control" required style="width:200px; color:black; display:none;" value="102" > 
