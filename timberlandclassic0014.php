...
<title>NTIMBERLAND CLASSIC</title>
    </head>
    <body>
...
<br>
                ...
                <img src="kepucet/timberlandclassic/2.jfif" alt="shkembi ne korce">

                <div class="pershkrimi" id="pershkrimi">
                    <p>TIMBERLAND CLASSIC</p>
                </div> 
...
<br>
                ...
                <img src="kepucet/timberlandclassic/1.jfif" alt="Kodra ne brezovice">
...
<br>
                ...
                <img src="kepucet/timberlandclassic/3.jfif" alt="Kodra ne brezovice">

                <div class="pershkrimi" id="pershkrimi">
                    <p style="text-transfrom:uppercase">TIMBERLAND CLASSIC</p>
                </div>
            </div>
        ...
        <div class="pikat-naviguese">
            <span class="pika" id="pika">155 &euro;</span>
        </div>
        </div>

        <div class="djatht">

             <h1 style="text-align:center; text-transform:capitalize;">TIMBERLAND CLASSIC</h1>
         ...
         <label for="numriser" style="color:black;display:none;">id</label> 
                ...
                <input type="text" name="numriser"id="numriser" class="form-control" required style="width:200px; color:black;display:none; z-index:-100;" value="TIMBERLAND CLASSIC ID#0014">
        ...
        <label for="cmimi" style="color:black;display:none;">Phone</label> 
                ...
                <input type="tel" name="cmimi" id="cmimi" class="form-control" required style="width:200px; color:black; display:none;" value="155" > 
