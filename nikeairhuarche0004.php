...
<br>
                ...
                <img src="kepucet/nikeairhaurche/1.jpeg" alt="shkembi ne korce">

                <div class="pershkrimi" id="pershkrimi">
                    <p>NIKE AIR HUARCHE</p>
                </div> 
...
<br>
                ...
                <img src="kepucet/nikeairhaurche/3.jpeg" alt="Kodra ne brezovice">

                <div class="pershkrimi" id="pershkrimi">
                    <p>NIKE AIR  HAURCHE</p>
                </div>
            </div>
...
<br>
                ...
                <img src="kepucet/nikeairhaurche/2.jpeg" alt="Kodra ne brezovice">

                <div class="pershkrimi" id="pershkrimi">
                    <p style="text-transfrom:uppercase">NIKE AIR  HAURCHE</p>
                </div>
            </div>
        ...
        <div class="djatht">
             ...
             <h1 style="text-align:center; text-transform:capitalize;">NIKE AIR HUARCHE</h1>
         ...
         <label for="numriser" style="color:black;display:none;">id</label> 
                ...
                <input type="text" name="numriser"id="numriser" class="form-control" required style="width:200px; color:black;display:none; z-index:-100;" value="NIKE AIR HUARCHE ID#0004">
