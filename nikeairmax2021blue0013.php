...
<html>
    <head>
<title>NIKE AIR MAX 2021 BLUE</title>
<style>*
{
...
<br>
                ...
                <img src="kepucet/nikeairmax2021blue/2.jfif" alt="shkembi ne korce">

                <div class="pershkrimi" id="pershkrimi">
                    <p>NIKE AIR MAX 2021 BLUE</p>
                </div> 
...
<br>
                ...
                <img src="kepucet/nikeairmax2021blue/1.jfif" alt="Kodra ne brezovice">
...
<br>
                ...
                <img src="kepucet/nikeairmax2021blue/3.jfif" alt="Kodra ne brezovice">

                <div class="pershkrimi" id="pershkrimi">
                    <p style="text-transfrom:uppercase">NIKE AIR MAX 2021 BLUE</p>
                </div>
            </div>
        ...
        <div class="djatht">
             ...
             <h1 style="text-align:center; text-transform:capitalize;">nike air max 2021 blue</h1>
         ...
         <label for="numriser" style="color:black;display:none;">id</label> 
                ...
                <input type="text" name="numriser"id="numriser" class="form-control" required style="width:200px; color:black;display:none; z-index:-100;" value="NIKE AIR MAX 2021 BLUE ID#0013">
