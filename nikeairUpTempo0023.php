...
<html>
 ...
 <title>NIKR AIR UP TEMPO 2022</title>
<style>
    *
{
...
<br>
                ...
                <img src="kepucet/nikeairuptempo2/1.jfif" alt="shkembi ne korce">

                <div class="pershkrimi" id="pershkrimi">
                    <p>NIKR AIR UP TEMPO 2022</p>
                </div> 
...
<br>
                ...
                <img src="kepucet/nikeairuptempo2/2.jfif" alt="Kodra ne brezovice">
...
<br>
                ...
                <img src="kepucet/nikeairuptempo2/3.jfif" alt="Kodra ne brezovice">

                <div class="pershkrimi" id="pershkrimi">
                    <p style="text-transfrom:uppercase">NIKR AIR UP TEMPO 2022</p>
                </div>
            </div>
        ...
        <div class="pikat-naviguese">
            <span class="pika" id="pika">135 &euro;</span>
        </div>
        </div>

        <div class="djatht">

             <h1 style="text-align:center; text-transform:capitalize;">NIKR AIR UP TEMPO 2022</h1>
         ...
         <label for="numriser" style="color:black;display:none;">id</label> 
                ...
                <input type="text" name="numriser"id="numriser" class="form-control" required style="width:200px; color:black;display:none; z-index:-100;" value="NIKR AIR UP TEMPO 2022 ID#0023">
        ...
        <label for="cmimi" style="color:black;display:none;">Phone</label> 
                ...
                <input type="tel" name="cmimi" id="cmimi" class="form-control" required style="width:200px; color:black; display:none;" value="135" > 
