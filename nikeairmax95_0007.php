...
<br>
                ...
                <img src="kepucet/nikeairmax95/1.jfif" alt="shkembi ne korce">
...
<br>
                ...
                <img src="kepucet/nikeairmax95/2.jfif" alt="Kodra ne brezovice">
...
<br>
                ...
                <img src="kepucet/nikeairmax95/1.jfif" alt="Kodra ne brezovice">

                <div class="pershkrimi" id="pershkrimi">
                    <p style="text-transfrom:uppercase">NIKE AIR MAX 95</p>
                </div>
            </div>
        ...
        <div class="pikat-naviguese">
            <span class="pika" id="pika">117 &euro;</span>
        </div>
        </div>

        <div class="djatht">

             <h1 style="text-align:center; text-transform:capitalize;">NIKE AIR MAX 95</h1>
         ...
         <label for="numriser" style="color:black;display:none;">id</label> 
                ...
                <input type="text" name="numriser"id="numriser" class="form-control" required style="width:200px; color:black;display:none; z-index:-100;" value="NIKE AIR MAX 95 ID#0007">
        ...
        <label for="cmimi" style="color:black;display:none;">Phone</label> 
                ...
                <input type="tel" name="cmimi" id="cmimi" class="form-control" required style="width:200px; color:black; display:none;" value="117" > 
