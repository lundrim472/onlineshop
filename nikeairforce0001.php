...
<br>
                ...
                <img src="kepucet/nikeairforce/2.jfif" alt="shkembi ne korce">
...
<br>
                ...
                <img src="kepucet/nikeairforce/1.jfif" alt="Kodra ne brezovice">
...
<br>
                ...
                <img src="kepucet/nikeairforce/3.jfif" alt="Kodra ne brezovice">

                <div class="pershkrimi" id="pershkrimi">
                    <p style="text-transfrom:uppercase">NIKE AIR FORCE</p>
                </div>
            </div>
        ...
        <div class="djatht">
             ...
             <h1 style="text-align:center; text-transform:capitalize;">nike air force</h1>
         ...
         <label for="numriser" style="color:black;display:none;">id</label> 
                ...
                <input type="text" name="numriser"id="numriser" class="form-control" required style="width:200px; color:black;display:none; z-index:-100;" value="NIKE AIR FORCE ID#0001">
