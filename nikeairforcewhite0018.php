...
<br>
                ...
                <img src="kepucet/nikeairforcewhite/2.jfif" alt="shkembi ne korce">

                <div class="pershkrimi" id="pershkrimi">
                    <p>NIKE FORCE WHITE</p>
                </div> 
...
<br>
                ...
                <img src="kepucet/nikeairforcewhite/1.jfif" alt="Kodra ne brezovice">
...
<br>
                ...
                <img src="kepucet/nikeairforcewhite/3.jfif" alt="Kodra ne brezovice">

                <div class="pershkrimi" id="pershkrimi">
                    <p style="text-transfrom:uppercase">NIKE FORCE WHITE</p>
                </div>
            </div>
        ...
        <div class="djatht">
             ...
             <h1 style="text-align:center; text-transform:capitalize;">NIKE FORCE WHITE</h1>
         ...
         <label for="numriser" style="color:black;display:none;">id</label> 
                ...
                <input type="text" name="numriser"id="numriser" class="form-control" required style="width:200px; color:black;display:none; z-index:-100;" value="NIKE FORCE WHITE ID#0018">
