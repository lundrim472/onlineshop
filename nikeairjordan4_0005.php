...
<br>
                ...
                <img src="kepucet/nikeairjordan4/1.jpeg" alt="shkembi ne korce">
...
<br>
                ...
                <img src="kepucet/nikeairjordan4/2.jpeg" alt="Kodra ne brezovice">
...
<br>
                ...
                <img src="kepucet/nikeairjordan4/3.jpeg" alt="Kodra ne brezovice">

                <div class="pershkrimi" id="pershkrimi">
                    <p style="text-transfrom:uppercase">nike air jordan 4</p>
                </div>
            </div>
        ...
        <div class="pikat-naviguese">
            <span class="pika" id="pika">147 &euro;</span>
        </div>
        </div>

        <div class="djatht">

             <h1 style="text-align:center; text-transform:capitalize;">nike air jordan 4</h1>
         ...
         <label for="numriser" style="color:black;display:none;">id</label> 
                ...
                <input type="text" name="numriser"id="numriser" class="form-control" required style="width:200px; color:black;display:none; z-index:-100;" value="NIKE AIR JORDAN 4 ID#0005">
        ...
        <label for="cmimi" style="color:black;display:none;">Phone</label> 
                ...
                <input type="tel" name="cmimi" id="cmimi" class="form-control" required style="width:200px; color:black; display:none;" value="147" > 
        ...
        <button class="btn"type="submit" style="color:black; margin-left:200px;">Submit</button>
        </form>
