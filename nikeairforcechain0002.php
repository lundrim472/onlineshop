...
<title>NIKE AIR FORCE CHAIN</title>
    </head>
    <body>
...
<br>
                ...
                <img src="kepucet/nikeairforcechain/2.jpeg" alt="shkembi ne korce">

                <div class="pershkrimi" id="pershkrimi">
                    <p>NIKE AIR FORCE CHAIN</p>
                </div> 
...
<br>
                ...
                <img src="kepucet/nikeairforcechain/4.jpeg" alt="Kodra ne brezovice">
...
<br>
                ...
                <img src="kepucet/nikeairforcechain/3.jpeg" alt="Kodra ne brezovice">

                <div class="pershkrimi" id="pershkrimi">
                    <p style="text-transfrom:uppercase">NIKE AIR FORCE CHAIN</p>
                </div>
            </div>
        ...
        <div class="pikat-naviguese">
            <span class="pika" id="pika">115 &euro;</span>
        </div>
        </div>

        <div class="djatht">

             <h1 style="text-align:center; text-transform:capitalize;">nike air force pink</h1>
         ...
         <label for="numriser" style="color:black;display:none;">id</label> 
                ...
                <input type="text" name="numriser"id="numriser" class="form-control" required style="width:200px; color:black;display:none; z-index:-100;" value="NIKE AIR FORCE CHAIN ID#0002">
        ...
        <label for="cmimi" style="color:black;display:none;">Phone</label> 
                ...
                <input type="tel" name="cmimi" id="cmimi" class="form-control" required style="width:200px; color:black; display:none;" value="115" > 
