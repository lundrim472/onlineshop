...
<title>NIKE AIR FORCE LUNAR</title>
    </head>
    <body>
...
<br>
                ...
                <img src="kepucet/nikeairforcelunar/2.jfif" alt="shkembi ne korce">

                <div class="pershkrimi" id="pershkrimi">
                    <p>NIKE AIR FORCE LUNAR</p>
                </div> 
...
<br>
                ...
                <img src="kepucet/nikeairforcelunar/1.jfif" alt="Kodra ne brezovice">
...
<br>
                ...
                <img src="kepucet/nikeairforcelunar/3.jfif" alt="Kodra ne brezovice">

                <div class="pershkrimi" id="pershkrimi">
                    <p style="text-transfrom:uppercase">NIKE AIR FORCE LUNAR</p>
                </div>
            </div>
        ...
        <div class="djatht">
             ...
             <h1 style="text-align:center; text-transform:capitalize;">NIKE AIR FORCE LUNAR</h1>
         ...
         <label for="numriser" style="color:black;display:none;">id</label> 
                ...
                <input type="text" name="numriser"id="numriser" class="form-control" required style="width:200px; color:black;display:none; z-index:-100;" value="NIKE AIR FORCE LUNAR ID#0020">
