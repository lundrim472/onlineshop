...
<br>
                ...
                <img src="kepucet/nikeairforce2/1.jfif" alt="shkembi ne korce">
...
<br>
                ...
                <img src="kepucet/nikeairforce2/2.jfif" alt="Kodra ne brezovice">
...
<br>
                ...
                <img src="kepucet/nikeairforce2/3.jfif" alt="Kodra ne brezovice">
        ...
        <div class="pikat-naviguese">
            <span class="pika" id="pika">105 &euro;</span>
        </div>
        </div>
        ...
        <div class="djatht">
         ...
         <label for="numriser" style="color:black;display:none;">id</label> 
                ...
                <input type="text" name="numriser"id="numriser" class="form-control" required style="width:200px; color:black;display:none; z-index:-100;" value="NIKE AIR FORCE ID#0011">
        ...
        <label for="cmimi" style="color:black;display:none;">Phone</label> 
                ...
                <input type="tel" name="cmimi" id="cmimi" class="form-control" required style="width:200px; color:black; display:none;" value="105" > 
